...
testRule({
	...
	reject: [
		...
		{
			code: String.raw`.u-m\2b {} .u-m\00002b {}`,
			description: 'duplicate selectors with short vs long hex escape',
			warnings: [
				{
					message: messages.rejected(String.raw`.u-m\00002b`, 1),
					line: 1,
					column: 12,
					endLine: 1,
					endColumn: 23,
