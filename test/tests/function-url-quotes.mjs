...
testRule({
	...
	reject: [
		...
		{
			code: String.raw`@import url(foo\ .css);`,
			fixed: String.raw`@import url("foo\ .css");`,
			fix: {
				range: [12, 21],
				text: String.raw`"foo\ .css"`,
			},
			message: messages.expected('url'),
			line: 1,
			column: 13,
...
testRule({
	...
	accept: [
		...
		{
			code: String.raw`a { background-image: url('data:image/svg+xml;utf8,<svg height="100" width="100">\3c style>.cls-1{}\3c /style></svg>'); }`,
			description:
				'data URI with embedded quotes requires quotes (#8544); escaped <style> by PostCSS v8.5.10+ (#9249)',
		},
		{
			code: String.raw`a { background-image: url('data:image/svg+xml,<svg height="100" width="100">\3c style>.cls-1{fill-rule:evenodd;}\3c /style></svg>'); }`,
			description:
				'data URI with embedded quotes requires quotes (#8544); escaped <style> by PostCSS v8.5.10+ (#9249)',
		},
		{
